...
//            }
            ...
            IStmt ex12 = new CompStmt(
                ...
                lastExampleRun = "ex12:" + ex12.toString();
                ex12.typecheck(new MyDictionary<>());
                PrgState prg12 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), ex12, new MyDictionary<>(), new MyHeap(),new MyLatchTable());
                IRepository repo12 = new Repository(prg12, "log12.txt");
                Controller ctr12 = new Controller(repo12, true);
                listOfExamples.add(ex12);
                listOfControllers.add(ctr12);
            ...
            try {
                ...
                PrgState prg18 = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), example18, new MyDictionary<>(), new MyHeap(),new MyLatchTable());
